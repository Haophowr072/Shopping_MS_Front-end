...
const Profile = () => {
                ...
                <div>
                    {cart.map(item => {
                        if (item) {
                            ...
                            return null; // Trả về null nếu item không tồn tại
                        }
                    })}
                </div>
            );
    ...
    const viewPlaceOrder = () => {
        if (Array.isArray(cart) && cart.length) {
            ...
            return (
                <div className="row bg-white" style={{ height: '5rem'}}>
                    ...
                    <div className="col-3 ml-auto">
                        <button className="btn btn-lg - btn-danger" onClick={() => onTapPlaceOrder()}>
            ...
            return null; // Hoặc bạn có thể trả về một phần tử JSX khác tùy thuộc vào yêu cầu của bạn
        }
    }
